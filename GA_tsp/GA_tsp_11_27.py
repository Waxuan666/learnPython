...
cityposition = cityposition[np.where(select_position == 1)]
...
b0 = ttk.Button(window, text='运行', width=10,command=canrun)
b1 = ttk.Button(window, text='查看结果', width=10,command=openhtml)
b0.pack()
b1.pack()
window.mainloop()
